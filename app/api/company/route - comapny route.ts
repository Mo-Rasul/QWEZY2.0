...
export async function POST(req: NextRequest) {
  try {
    ...
    if (isExistingUser) {
      ...
      credentialsHtml = `<div style="background:#f8fafd;border:1px solid #e5e7eb;border-radius:10px;padding:22px 24px;margin-bottom:28px;"><p style="font-size:14px;color:#374151;margin-bottom:4px;">You already have a Qwezy account with this email.</p><p style="font-size:14px;color:#374151;margin-bottom:14px;">Click below to set a password and access your new <strong>${companyName}</strong> workspace.</p><a href="${resetUrl}" style="display:inline-block;background:#059669;color:#fff;text-decoration:none;padding:10px 22px;border-radius:7px;font-weight:600;font-size:13.5px;">Set password &amp; continue →</a></div>`
    } else {
